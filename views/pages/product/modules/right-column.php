...
$url = CurlController::api()."relations?rel=products,categories,subcategories,stores&type=product,category,subcategory,store&linkTo=id_store_product&equalTo=".$item->id_store."&orderBy=id_product&orderMode=DESC&startAt=0&endAt=4";
$method = "GET";
$fields = array();
$header = array();
